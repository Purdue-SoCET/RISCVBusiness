...
PRIV_FILES := $(PRIVS)/priv_wrapper.sv  $(PRIVS)/priv_1_13/priv_1_13_block.sv  $(PRIVS)/priv_1_13/priv_1_13_int_ex_handler.sv  $(PRIVS)/priv_1_13/priv_1_13_csr.sv  $(PRIVS)/priv_1_13/priv_1_13_pipe_control.sv $(PRIVS)/priv_1_13/priv_1_13_pma.sv
