...
add wave -noupdate -group VEX_datapath /TOP/top_core/CORE/pipeline/execute_stage_i/RVV_DATAPATH/vex_stall
...
add wave -noupdate -expand -group vlane_data /TOP/top_core/CORE/pipeline/mem_stage_i/vlane_data
add wave -noupdate -expand -group vlane_data /TOP/top_core/CORE/pipeline/mem_stage_i/vlane_data
add wave -noupdate -expand -group vlane_data /TOP/top_core/CORE/pipeline/mem_stage_i/vlane_data
add wave -noupdate -expand -group vlane_data /TOP/top_core/CORE/pipeline/mem_stage_i/vlane_data
add wave -noupdate /TOP/top_core/CORE/pipeline/mem_stage_i/vlane_wen
add wave -noupdate -divider Memory
add wave -noupdate /TOP/top_core/CORE/pipeline/execute_stage_i/RVV_DATAPATH/VBANK0/v0
...
add wave -noupdate -expand -group {Mem to vector RF} -radix binary /TOP/top_core/CORE/pipeline/mem_stage_i/vlane_wen
