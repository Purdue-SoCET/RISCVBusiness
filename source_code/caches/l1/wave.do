...
add wave -noupdate -expand -subitemconfig {{/l1_cache_tb/DUT/egress_queue[2]} -expand {/l1_cache_tb/DUT/egress_queue[1]} -expand {/l1_cache_tb/DUT/egress_queue[0]} -expand} /l1_cache_tb/DUT/egress_queue
add wave -noupdate /l1_cache_tb/DUT/eq_wptr
add wave -noupdate /l1_cache_tb/DUT/eq_datain
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {15310 ps} 0}
