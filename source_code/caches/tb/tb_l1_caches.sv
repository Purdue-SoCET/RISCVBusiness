...
module tb_l1_caches ();
    ...
    (
        ...
        .ccif(d_cache_coherency_if) //Coherency interface, connected to coherency unit
    );
  ...
  initial begin : MAIN
    ...
    for (i = 0; i < 9; i++) begin // iterate through all the ways
      tb_addr[TAG_BIT-1 -: 4] = 4'(i); // set bits in the tag
