    ...
    if (prv_intern_if.csr_addr[11:10] == 2'b11 && !prv_intern_if.csr_read_only) begin
      ...
      if (prv_intern_if.valid_write) begin
        casez(prv_intern_if.csr_addr)
          MSTATUS_ADDR: begin
            if (prv_intern_if.new_csr_val[12:11] == RESERVED_MODE || (prv_intern_if.new_csr_val[12:11] == S_MODE && SUPERVISOR_ENABLED[HART_ID] == "disabled")) begin
              assert(SUPERVISOR_ENABLED[HART_ID] == "enabled");
  ...
  function logic check_bad_mcounteren;
      ...
      check_bad_mcounteren = (
          ...
          (
              ...
              (SUPERVISOR_ENABLED[HART_ID] == "enabled" & prv_intern_if.isUMode & mcounteren_bit)
          )
      );
  endfunction
endmodule
