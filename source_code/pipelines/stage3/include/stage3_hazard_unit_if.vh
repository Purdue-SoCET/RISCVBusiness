...
interface stage3_hazard_unit_if();
  ...
  logic jump, branch, fence_stall, amo_stall;
  ...
  modport hazard_unit (
    input   rs1_e, rs2_e, rd_m,
            ...
            jump, branch, fence_stall, amo_stall, update_predictor, mispredict, halt, pc_f, pc_e, pc_m,
  ...
  modport mem (
    ...
    output  rd_m, reg_write, csr_read,
            ...
            jump, branch, fence_stall, amo_stall, update_predictor, mispredict, halt, pc_m, valid_m,
