...
entity booth_multiplier_13bit is
generic(
...
end entity booth_multiplier_13bit;

architecture behavioral of booth_multiplier_13bit is
---------------------------------------------------------------------------------
...
type s_partial_prod_array is array(0 to 6) of 
     std_logic_vector(25 downto 0); -- array of partial product 
type s_sum_array is array(0 to 6) of 
     std_logic_vector(25 downto 0);   -- array of sum data
...
signal s_sum_1stage_adder1        : std_logic_vector(18 downto 0);
signal s_sum_1stage_adder1_opt    : std_logic_vector(15 downto 0);
signal s_sum_1stage_adder1_opt_d  : std_logic_vector(15 downto 0);
signal s_sum_1stage_adder1_extd   : std_logic_vector(22 downto 0);
signal s_sum_1stage_adder2        : std_logic_vector(22 downto 0);
signal s_sum_1stage_adder2_opt    : std_logic_vector(15 downto 0);
signal s_sum_1stage_adder2_opt_d  : std_logic_vector(15 downto 0);
signal s_sum_1stage_adder3        : std_logic_vector(25 downto 0);
signal s_sum_1stage_adder3_opt    : std_logic_vector(15 downto 0);
signal s_sum_1stage_adder3_opt_d  : std_logic_vector(15 downto 0);
signal s_sum_2stage_adder1        : std_logic_vector(23 downto 0);
signal s_sum_2stage_adder1_opt    : std_logic_vector(19 downto 0);
signal s_sum_2stage_adder1_extd   : std_logic_vector(25 downto 0);
signal s_sum_2stage_adder2        : std_logic_vector(26 downto 0);
signal s_sum_2stage_adder2_opt    : std_logic_vector(19 downto 0);
signal s_sum_2stage_adder2_extd   : std_logic_vector(25 downto 0);
signal s_sum_final_adder          : std_logic_vector(26 downto 0);
signal s_sum_final_adder_opt      : std_logic_vector(14 downto 0);
signal s_partial_prod_6_d         : std_logic_vector(13 downto 0);

signal s_multiplier      : std_logic_vector(15 downto 0); 
signal s_multiplicand    : std_logic_vector(13 downto 0); 
...
port map(
  ...
  o_partial_prod   => s_partial_prod(ii)(25 downto 0)
);
...
port map(
  i_input_data1    => s_partial_prod(0)(16 downto 2),
  i_input_data2    => s_partial_prod(1)(14 downto 0),
...
s_sum_1stage_adder1  <= s_sum_1stage_adder1_opt(15) & s_sum_1stage_adder1_opt & s_partial_prod(0)(1 downto 0);
inst_stage1_adder2 : carry_lookahead_adder
generic map(
  data_width       => 15
)
port map(
  i_input_data1    => s_partial_prod(2)(16 downto 2),
  i_input_data2    => s_partial_prod(3)(14 downto 0),
...
s_sum_1stage_adder2 <= s_sum_1stage_adder2_opt(15) & s_sum_1stage_adder2_opt & s_partial_prod(2)(1 downto 0) & "0000";
...
port map(
  i_input_data1    => s_partial_prod(4)(16 downto 2),
  i_input_data2    => s_partial_prod(5)(14 downto 0),
...
---------------------------------------------------------------------------------
s_sum_1stage_adder1_extd  <= (22 downto 19 => s_sum_1stage_adder1(18)) & s_sum_1stage_adder1;
inst_stage2_adder1 : carry_lookahead_adder
generic map(
  data_width       => 19
)
port map(
  i_input_data1    => s_sum_1stage_adder1_extd(22 downto 4),
  i_input_data2    => s_sum_1stage_adder2(22 downto 4),
  o_sum_data       => s_sum_2stage_adder1_opt
);

s_sum_2stage_adder1 <= s_sum_2stage_adder1_opt & s_sum_1stage_adder1_extd(3 downto 0);
s_sum_2stage_adder1_extd <=  s_sum_2stage_adder1 (23) & s_sum_2stage_adder1 (23) & s_sum_2stage_adder1;
...
port map(
  i_input_data1    => s_sum_2stage_adder1_extd(24 downto 6),
  i_input_data2    => s_sum_1stage_adder3(24 downto 6),
  o_sum_data       => s_sum_2stage_adder2_opt
);

s_sum_2stage_adder2      <= s_sum_2stage_adder2_opt(19) & s_sum_2stage_adder2_opt & s_sum_2stage_adder1_extd(5 downto 0);
s_sum_2stage_adder2_extd <= s_sum_2stage_adder2(25 downto 0);
...
-- begin
  -- if(rising_edge(i_clk)) then
    -- s_partial_prod_6_d <= s_partial_prod(6)(13 downto 0);
  -- end if;
...
port map(
  i_input_data1    => s_sum_2stage_adder2_extd(25 downto 12),
  i_input_data2    => s_partial_prod(6)(13 downto 0),
  o_sum_data       => s_sum_final_adder_opt
);

s_sum_final_adder  <= s_sum_final_adder_opt & s_sum_2stage_adder2_extd(11 downto 0);

--o_product   <= s_sum_final_adder(25 downto 0);
