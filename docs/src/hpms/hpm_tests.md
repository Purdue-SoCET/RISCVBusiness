...
- Add automated checks that run small workloads and assert: (1) counters  increase where expected, (2) hits+misses within expected ratio bands, (3) sampling with `mcountinhibit` yields reproducible results.
